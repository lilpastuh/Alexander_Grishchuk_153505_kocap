...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableWidget_4->setGeometry(QRect(900, 220, 521, 311));
        pushButton_3 = new QPushButton(centralwidget);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(1010, 170, 351, 31));
        pushButton_4 = new QPushButton(centralwidget);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(10, 580, 281, 21));
        FileWrite = new QPushButton(centralwidget);
        FileWrite->setObjectName(QStringLiteral("FileWrite"));
        FileWrite->setGeometry(QRect(942, 640, 111, 28));
        ReadFromFile = new QPushButton(centralwidget);
        ReadFromFile->setObjectName(QStringLiteral("ReadFromFile"));
        ReadFromFile->setGeometry(QRect(1080, 640, 111, 28));
        ChooseFile = new QPushButton(centralwidget);
        ChooseFile->setObjectName(QStringLiteral("ChooseFile"));
        ChooseFile->setGeometry(QRect(1210, 640, 111, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        FileWrite->setText(QApplication::translate("MainWindow", "\320\267\320\260\320\277\320\270\321\201\321\214 \320\262 \321\204\320\260\320\271\320\273", Q_NULLPTR));
        ReadFromFile->setText(QApplication::translate("MainWindow", "\321\207\320\270\321\202\320\260\321\202\321\214 \320\270\320\267 \321\204\320\260\320\271\320\273\320\260", Q_NULLPTR));
        ChooseFile->setText(QApplication::translate("MainWindow", "\320\262\321\213\320\261\321\200\320\260\321\202\321\214 \321\204\320\260\320\271\320\273", Q_NULLPTR));
    } // retranslateUi
